...
void Sprite::renderPlayerLeft() const
{
	glm::mat4 modelview = glm::translate(glm::mat4(1.0f), glm::vec3(position.x-20, position.y+4, 0.f));
	modelview = glm::translate(modelview, glm::vec3(16.f, 16.f, 0.f));
	modelview = glm::rotate(modelview, 3.9f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-16.f, -16.f, 0.f));
	shaderProgram->setUniformMatrix4f("modelview", modelview);
	shaderProgram->setUniform2f("texCoordDispl", texCoordDispl.x, texCoordDispl.y);
	glEnable(GL_TEXTURE_2D);
...
void Sprite::renderPlayerRight() const
{
	glm::mat4 modelview = glm::translate(glm::mat4(1.0f), glm::vec3(position.x + 20, position.y + 4, 0.f));
	modelview = glm::translate(modelview, glm::vec3(16.f, 16.f, 0.f));
	modelview = glm::rotate(modelview, 0.75f, glm::vec3(0.0f, 0.0f, 1.0f));
	modelview = glm::translate(modelview, glm::vec3(-16.f, -16.f, 0.f));
	shaderProgram->setUniformMatrix4f("modelview", modelview);
	shaderProgram->setUniform2f("texCoordDispl", texCoordDispl.x, texCoordDispl.y);
	glEnable(GL_TEXTURE_2D);
