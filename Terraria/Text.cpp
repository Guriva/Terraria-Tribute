...
void Text::render(char c, const glm::vec2 &pixel, int size, const glm::vec4 &color, glm::mat4 projectionM)
{
	//int vp[4];
...
void Text::render(const string &str, const glm::vec2 &pixel, int size, const glm::vec4 &color, glm::mat4 projectionM)
{
	//int vp[4];
	glm::mat4 projection, modelview;
