...
void Stone::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram, TileMap *tileMap) {
	...
	spritesheet.loadFromFile("images/Items/Stone.png", TEXTURE_PIXEL_FORMAT_RGBA);
...
bool Stone::use(glm::ivec2 posMouse) {
