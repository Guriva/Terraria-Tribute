...
void IronOre::init(const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram, TileMap *tileMap) {
	...
	spritesheet.loadFromFile("images/Items/Iron.png", TEXTURE_PIXEL_FORMAT_RGBA);
...
bool IronOre::use(glm::ivec2 posMouse) {
